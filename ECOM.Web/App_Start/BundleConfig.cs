...
namespace ECOM.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Foxconn.Framework
            bundles.Add(new ScriptBundle("~/bundles/ECOM.Framework").Include(
            "~/Scripts/oframework.js"));

            bundles.Add(new ScriptBundle("~/bundles/dnd").Include(
               "~/Scripts/jquery-timing.min.js",
               "~/Scripts/plugins/dnd/interact-1.2.3.js",
               "~/Scripts/plugins/dnd/jquery.connections.js",
               "~/Scripts/plugins/dnd/jquery.sortable.js",
               "~/Scripts/plugins/dnd/jquery.panzoom.min.js",
               "~/Scripts/plugins/dnd/jquery.mousewheel.js"));
            ...
            //FileStyle
            bundles.Add(new ScriptBundle("~/bundles/filestyle").Include("~/Scripts/bootstrap-filestyle.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/dataTables").Include(
                      ...
                      "~/Scripts/plugins/dataTables/buttons.colVis.js"));
            ...
            // Clippy Styles
            bundles.Add(new StyleBundle("~/plugins/clippyStyle").Include(
                      "~/Content/plugins/clippy/clippy.css"));

            // Clippy
            bundles.Add(new ScriptBundle("~/plugins/clippy").Include(
                      "~/Scripts/plugins/clippy/clippy.min.js"));

            // toastr alert Styless
            bundles.Add(new StyleBundle("~/plugins/toastrStyle").Include(
                      "~/Content/plugins/toastr/toastr.min.css"));
            ...
            // Vendor Flags
            bundles.Add(new StyleBundle("~/plugins/vendorFlags").Include(
                      "~/Content/plugins/vendor/flag-icon-css/flag-icon.css"));
            ...
            //Scroll Top
            bundles.Add(new ScriptBundle("~/Scripts/ScrollTop").Include(
